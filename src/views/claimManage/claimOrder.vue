    ...
    <section>
		...
		<el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
			<el-form :inline="true" :model="ruleForm" :rules="rules" ref="ruleForm" class="demo-form-inline">
                <el-form-item label="订单号" prop="ticketNo">
                    <el-input v-model="ruleForm.ticketNo" placeholder="订单号"></el-input>
                </el-form-item>
                <el-form-item label="物流单号" prop="expressNo">
                    <el-input v-model="ruleForm.expressNo" placeholder="物流单号"></el-input>
                </el-form-item>
                ...
                <el-form-item>
                    ...
                    <el-button><router-link to="/claimManage/claimOrderAdd">新增理赔</router-link></el-button>
                    <el-button @click="resetForm('ruleForm')">批量理赔</el-button>
