      ...
      <el-card class="box-card" shadow="hover" style="margin-top:30px;">
        ...
        <el-row>
          ...
          <el-col :span="6" v-if="checkOptions('目的口岸')">
            <el-form-item label="目的口岸" :span="6">
...
<script>
    ...
    export default {
        ...
        methods: {
          ...
          // 确认支付
          confirmToPay() {
            this.$confirm(`${this.payInfo.title}<div style="text-align:center">投保金额：<span style="color:red;">${this.payInfo.discountAmount}</span></div><div style="text-align:center">余额：<span style="color:red;">${this.payInfo.balance}</span></div>`, '确认信息', {
